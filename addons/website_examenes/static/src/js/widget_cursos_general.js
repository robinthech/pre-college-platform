odoo.define('website_examenes.cursos_general_seccion_one2many', function (require){
"use strict";
...
var SectionListRenderer = ListRenderer.extend({
    init: function (parent, state, params) {
        this.sectionFieldName = "is_curso";
    ...
    _renderBodyCell: function (record, node, index, options){
        ...
        if (isSection){
            if (node.attrs.widget === "handle"){
                return $cell;
            } else if (node.attrs.name === "curso_general_id"){
...
FieldRegistry.add('cursos_general_seccion_one2many', SectionFieldOne2Many);
});
