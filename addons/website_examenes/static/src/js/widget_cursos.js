odoo.define('website_examenes.cursos_seccion_one2many', function (require){
"use strict";
    ...
    _renderBodyCell: function (record, node, index, options){
        ...
        if (isSection){
            if (node.attrs.widget === "handle"){
                return $cell;
            } else if (node.attrs.name === "curso_id"){
...
FieldRegistry.add('cursos_seccion_one2many', SectionFieldOne2Many);
});
